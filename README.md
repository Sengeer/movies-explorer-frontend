...
1. Сохраните фронтенд и [бэкенд](https://github.com/Sengeer/movies-explorer-api.ru) на компьютер
![Сохранить на компьютер](https://github.com/Sengeer/movies-explorer-frontend/assets/63221404/a544f473-7921-4e60-9d4f-539d7731474a)
